...
auto MainWindow::createCentralWidget() -> QWidget *
{
	...
	contextView = new View::Context(*spotify, settings, current, cache, this);

	// Left side panel
	addDockWidget(Qt::LeftDockWidgetArea,
		WidgetUtils::createDockWidget(libraryList, "Library", this));
	addDockWidget(Qt::LeftDockWidgetArea,
		WidgetUtils::createDockWidget(playlistList, "Playlist", this));
	addDockWidget(Qt::LeftDockWidgetArea,
